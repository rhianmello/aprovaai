...
function injectPricing(){
 ...
 if(!document.getElementById('np-pricing-css')){const s=document.createElement('style');s.id='np-pricing-css';s.textContent=`#np-pricing{border-top:1px solid #33404c;border-bottom:1px solid #33404c;background:linear-gradient(180deg,#080d13,#0c1219);padding:24px 0 28px}.np-price-deco{position:absolute;z-index:2;pointer-events:none;text-align:center;font-weight:900;line-height:1.35}.np-price-deco.left{left:5px;top:18px;width:78px;color:#62c3ed}.np-price-deco.right{right:5px;top:20px;width:82px;color:#e4c64a}.np-price-deco.top{right:8px;top:-4px;width:105px;color:#e4c64a}.np-price-deco .np-deco-icon{display:block;font-size:48px;line-height:1;margin-bottom:10px;filter:drop-shadow(0 8px 12px rgba(0,0,0,.35))}.np-price-deco .np-deco-text{font-size:11px;font-style:italic;letter-spacing:.2px}.np-price-deco .np-arrow{display:block;font-size:26px;margin-top:6px}.np-price-deco.top .np-deco-icon{font-size:28px}.np-price-deco.top .np-deco-text{font-size:10px}#np-pricing .np-price-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;align-items:stretch}.np-price-card{position:relative;display:flex;flex-direction:column;min-height:245px;padding:22px;border:1px solid #2b3743;border-radius:16px;background:linear-gradient(145deg,#111a23,#0b1016);box-shadow:0 10px 30px rgba(0,0,0,.18)}.np-price-card h3{margin:0 0 8px;font-size:13px;color:#dce3e9;text-transform:uppercase;letter-spacing:1px}.np-price-card .np-price-title{font-size:23px;font-weight:950;margin:0 0 8px}.np-price-card .np-price-title b{color:#e4c64a}.np-price-card p{color:#929eaa;font-size:11px;line-height:1.5;margin:0 0 12px}.np-price-card ul{list-style:none;padding:0;margin:0 0 16px;color:#b7c0c8;font-size:10px;line-height:1.9}.np-price-card li:before{content:'✓';color:#53d5a0;font-weight:900;margin-right:7px}.np-price-card .np-price-foot{margin-top:auto;display:flex;align-items:end;justify-content:space-between;gap:10px}.np-price-value strong{display:block;font-size:25px}.np-price-value span{font-size:9px;color:#7d8995}.np-price-btn{display:inline-flex;align-items:center;justify-content:center;border-radius:10px;padding:10px 13px;background:#e4c64a;color:#111;text-decoration:none;font-size:10px;font-weight:950}.np-price-btn.dark{background:#131a22;color:#fff;border:1px solid #303a46}.np-price-card.featured{border-color:#62c3ed;box-shadow:0 0 0 1px rgba(98,195,237,.12),0 12px 35px rgba(0,0,0,.25)}.np-price-card.featured:before{content:'★ MAIS ESCOLHIDO';position:absolute;top:-11px;left:50%;transform:translateX(-50%);background:#168cf5;color:#fff;border-radius:999px;padding:6px 12px;font-size:9px;font-weight:950;white-space:nowrap}.np-price-card.pro .np-price-value strong{color:#53d5a0}.np-price-note{text-align:center;color:#687581;font-size:9px;margin-top:16px}.np-price-note b{color:#aeb7c0}@media(max-width:1050px){#np-pricing .np-price-deco{display:none}}@media(max-width:900px){#np-pricing .np-price-grid{grid-template-columns:1fr}.np-price-card{min-height:0}}@media(max-width:620px){#np-pricing{padding:22px 0}.np-price-card{padding:18px}}`;document.head.appendChild(s)}
 const section=document.createElement('section');section.id='np-pricing';section.innerHTML=`<div class="wrap"><div class="np-price-deco top"><span class="np-deco-icon">↗</span><span class="np-deco-text">Acompanhe seu progresso e evolua!</span></div><div class="np-price-deco left"><span class="np-deco-icon">🎓</span><span class="np-deco-text">Seu futuro começa aqui!</span><span class="np-arrow">↘</span></div><div class="np-price-deco right"><span class="np-deco-icon">🏆</span><span class="np-deco-text">Disciplina hoje.<br>Aprovação amanhã!</span><span class="np-arrow">↙</span></div><div class="np-price-grid"><article class="np-price-card"><h3>Plano gratuito</h3><div class="np-price-title">Comece <b>agora</b></div><p>Acesso gratuito para conhecer a plataforma e começar sua preparação.</p><ul><li>Questões diárias limitadas</li><li>1 simulado por semana</li><li>Acesso a algumas bancas</li><li>Desempenho básico</li><li>Plano de estudos básico</li></ul><div class="np-price-foot"><div class="np-price-value"><strong>R$ 0</strong><span>para sempre</span></div><a class="np-price-btn dark" href="login.html">Criar conta</a></div></article><article class="np-price-card featured"><h3>Plano teste</h3><div class="np-price-title">7 dias por <b>R$1</b></div><p>Acesso praticamente completo para você testar tudo antes de decidir.</p><ul><li>Acesso completo à plataforma</li><li>Simulados ilimitados</li><li>Todas as bancas e concursos</li><li>Estatísticas e análise de desempenho</li><li>Ranking completo</li><li>Plano de estudos personalizado</li></ul><div class="np-price-foot"><div class="np-price-value"><strong>R$ 1,00</strong><span>por 7 dias</span></div><a class="np-price-btn" href="login.html">Quero testar por R$1</a></div></article><article class="np-price-card pro"><h3>Plano PRO</h3><div class="np-price-title">Continue <b>evoluindo</b></div><p>Depois do teste, mantenha seu acesso completo e siga firme na preparação.</p><ul><li>Tudo do plano de teste</li><li>Simulados ilimitados</li><li>Estatísticas avançadas</li><li>Plano de estudos inteligente</li><li>IA para explicar questões</li><li>Suporte prioritário</li></ul><div class="np-price-foot"><div class="np-price-value"><strong>R$ 5,90</strong><span>por mês</span></div><a class="np-price-btn" href="login.html">Assinar PRO</a></div></article></div><div class="np-price-note"><b>Teste por apenas R$1.</b> Depois dos 7 dias, o plano PRO será apresentado para você. • Pagamento seguro</div></div>`;
 hero.after(section);
}
async function ping(){
 try{
