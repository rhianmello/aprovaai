...
(async()=>{try{
 ...
 const bal=document.createElement('script');bal.src='./question-balance-runtime.js?v=20260922-2';
 bal.onload=()=>{const s=document.createElement('script');s.src='./study-dashboard-stable-v2.js?v=20260922-2';s.onload=()=>{const q=document.createElement('script');q.src='./study-dashboard-question-syllabus.js?v=20260922-2';document.body.appendChild(q)};document.body.appendChild(s);s.onerror=()=>page('Não foi possível abrir a área de estudos.','O painel não carregou. Tente atualizar a página novamente.')};
