...
(async()=>{try{
 ...
 const bal=document.createElement('script');bal.src='./question-balance-runtime.js?v=20260914-1';document.body.appendChild(bal);
 const s=document.createElement('script');s.src='./study-dashboard-stable-v2.js?v=20260914-1';document.body.appendChild(s);s.onerror=()=>page('Não foi possível abrir a área de estudos.','O painel não carregou. Tente atualizar a página novamente.')
