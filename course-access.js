...
async function configureDashboard(client,course){
 ...
 const bankLoader=async()=>{const r=await client.rpc('load_student_question_bank',{p_course_id:course.id,p_preparation_id:prep.id});if(r.error)throw r.error;return r.data||[]};
